...
// class MireaTextTheme extends ThemeExtension<MireaTextTheme> {
...
//   @override
//   ThemeExtension<MireaTextTheme> copyWith({
...
//   @override
//   ThemeExtension<MireaTextTheme> lerp(
//       covariant ThemeExtension<MireaTextTheme>? other, double t) {
//     if (other is! MireaTextTheme) {
//       return this;
//     }
//     return MireaTextTheme(
...
//   static get light => MireaTextTheme(
//         defaultText12:
//             getStyle(fontSize: 12, color: AppColors.defaultBlackColor),
//         defaultText14:
//             getStyle(fontSize: 14, color: AppColors.defaultBlackColor),
//         defaultText16:
//             getStyle(fontSize: 16, color: AppColors.defaultBlackColor),
//         defaultText18:
//             getStyle(fontSize: 18, color: AppColors.defaultBlackColor),
//         defaultText20:
//             getStyle(fontSize: 20, color: AppColors.defaultBlackColor),
...
//         whiteText12: getStyle(color: AppColors.defaultWhiteColor, fontSize: 12),
//         whiteText14: getStyle(color: AppColors.defaultWhiteColor, fontSize: 14),
//         whiteText16: getStyle(color: AppColors.defaultWhiteColor, fontSize: 16),
//         whiteText18: getStyle(color: AppColors.defaultWhiteColor, fontSize: 18),
//         whiteText20: getStyle(color: AppColors.defaultWhiteColor, fontSize: 20),
...
//   static get dark => MireaTextTheme(
//         defaultText12:
//             getStyle(fontSize: 12, color: AppColors.defaultWhiteColor),
//         defaultText14:
//             getStyle(fontSize: 14, color: AppColors.defaultWhiteColor),
//         defaultText16:
//             getStyle(fontSize: 16, color: AppColors.defaultWhiteColor),
//         defaultText18:
//             getStyle(fontSize: 18, color: AppColors.defaultWhiteColor),
//         defaultText20:
//             getStyle(fontSize: 20, color: AppColors.defaultWhiteColor),
...
class MireaTextTheme extends ThemeExtension<MireaTextTheme> {
  ...
  static get light => MireaTextTheme(
        // defaultText - основной текст темно-серый
        defaultText12: getStyle(fontSize: 12, color: AppColors.textPrimary),
        defaultText14: getStyle(fontSize: 14, color: AppColors.textPrimary),
        defaultText16: getStyle(fontSize: 16, color: AppColors.textPrimary),
        defaultText18: getStyle(fontSize: 18, color: AppColors.textPrimary),
        defaultText20: getStyle(fontSize: 20, color: AppColors.textPrimary),

        // blueText - темно-синий цвет бренда
        blueText12: getStyle(color: AppColors.primaryLight, fontSize: 12),
        blueText14: getStyle(color: AppColors.primaryLight, fontSize: 14),
        blueText16: getStyle(color: AppColors.primaryLight, fontSize: 16),
        blueText18: getStyle(color: AppColors.primaryLight, fontSize: 18),
        blueText20: getStyle(color: AppColors.primaryLight, fontSize: 20),

        // whiteText - белый текст
        whiteText12: getStyle(color: AppColors.textOnPrimary, fontSize: 12),
        whiteText14: getStyle(color: AppColors.textOnPrimary, fontSize: 14),
        whiteText16: getStyle(color: AppColors.textOnPrimary, fontSize: 16),
        whiteText18: getStyle(color: AppColors.textOnPrimary, fontSize: 18),
        whiteText20: getStyle(color: AppColors.textOnPrimary, fontSize: 20),

        // defaultTextFat - жирный основной текст
        defaultText12Fat: getStyle(
        ...
        // blueTextFat - жирный темно-синий
        blueText12Fat: getStyle(
  ...
  static get dark => MireaTextTheme(
        // defaultText - основной текст белый в темном режиме
        defaultText12: getStyle(fontSize: 12, color: AppColors.textOnPrimary),
        defaultText14: getStyle(fontSize: 14, color: AppColors.textOnPrimary),
        defaultText16: getStyle(fontSize: 16, color: AppColors.textOnPrimary),
        defaultText18: getStyle(fontSize: 18, color: AppColors.textOnPrimary),
        defaultText20: getStyle(fontSize: 20, color: AppColors.textOnPrimary),

        // blueText - темно-синий в темном режиме
        blueText12: getStyle(color: AppColors.primaryLightDark, fontSize: 12),
        blueText14: getStyle(color: AppColors.primaryLightDark, fontSize: 14),
        blueText16: getStyle(color: AppColors.primaryLightDark, fontSize: 16),
        blueText18: getStyle(color: AppColors.primaryLightDark, fontSize: 18),
        blueText20: getStyle(color: AppColors.primaryLightDark, fontSize: 20),
        ...
        // defaultTextFat - жирный белый текст
        defaultText12Fat: getStyle(
            color: AppColors.textOnPrimary,
            fontSize: 12,
            fontWeight: FontWeight.w500),
